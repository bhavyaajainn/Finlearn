...
from .routes import watchlist_router, learning_router, selectedtopics_router
# research_router
...
api_router.include_router(selectedtopics_router, prefix="/selectedtopics", tags=["selectedtopics"])