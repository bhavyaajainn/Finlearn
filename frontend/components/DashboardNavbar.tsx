      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-zinc-900 border-b border-zinc-800 px-4 py-4">
          <div className="flex flex-col space-y-4">
            <Link
              href="/dashboard"
              className={`${isActiveLink('/dashboard') ? 'text-blue-400' : 'text-gray-300'} hover:text-blue-400`}
            ...
            <Link
              href="/dashboard/watchlist"
              className={`${isActiveLink('/dashboard/watchlist') ? 'text-blue-400' : 'text-gray-300'} hover:text-blue-400`}
              onClick={() => setMobileMenuOpen(false)}
            >
              Watchlist
            </Link>
            <Link
              href="/dashboard/learning"
              className={`${isActiveLink('/dashboard/learning') ? 'text-blue-400' : 'text-gray-300'} hover:text-blue-400`}
              onClick={() => setMobileMenuOpen(false)}
            >
              Learning Hub
            </Link>
