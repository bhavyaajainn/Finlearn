...
import { ArrowLeft, TrendingUp, AlertTriangle, Users, BookOpen, Calendar } from "lucide-react"
            ...
            <div className="container mx-auto py-8 px-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    <div className="lg:col-span-2">
                        <h1 className="text-3xl font-bold text-blue-500">{asset.name}</h1>
                        <div className="flex items-center gap-2 mt-1">
                            <span className="text-xl font-mono">${asset.price.toLocaleString()}</span>
                            <span className={`text-lg ${asset.change >= 0 ? "text-green-500" : "text-red-500"}`}>
                                {asset.change >= 0 ? "+" : ""}
                    ...
                    <div className="lg:col-span-1 flex flex-col sm:flex-row lg:flex-col gap-4 justify-between">
                ...
                <Card className="bg-gray-900 border-gray-800 mb-8">
                    <CardHeader>
                        <CardTitle className="text-blue-400">About {asset.name}</CardTitle>
                        <CardDescription className="text-gray-400">
                            {asset.sector} • {asset.industry} • Founded {asset.yearFounded}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Tabs defaultValue="chart" className="w-full">
                    <TabsList className="bg-gray-800 border-b border-gray-700 w-full justify-start mb-6">
                        <TabsTrigger value="chart" className="data-[state=active]:bg-blue-900/30 data-[state=active]:text-blue-400">
                            <TrendingUp className="mr-2 h-4 w-4" />
                            Price Chart
                        </TabsTrigger>
                        <TabsTrigger value="news" className="data-[state=active]:bg-blue-900/30 data-[state=active]:text-blue-400">
                            <BookOpen className="mr-2 h-4 w-4" />
                            Latest News
                        </TabsTrigger>
                        <TabsTrigger value="risks" className="data-[state=active]:bg-blue-900/30 data-[state=active]:text-blue-400">
