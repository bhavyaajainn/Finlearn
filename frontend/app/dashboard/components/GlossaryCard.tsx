    ...
    <>
      <Card className="bg-black border-blue-900/50">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <Button variant="ghost" size="sm" className="text-blue-400 hover:text-blue-300 hover:bg-blue-950/50">
            View All
            ...
            {glossaryTerms.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  <p className="text-sm text-gray-400 line-clamp-2">{item.definition}</p>
                </div>
              </motion.div>
            ))}
          </div>
